...
public class BlueParticle extends AbstractParticle{

	public BlueParticle(PerspectiveCamera camera) {
		super(camera);
		
		//Cria as partículas azuis do jogo
		...
		AssetManagement.assetManager.load("particles/cylinder_blue2.p", ParticleEffect.class, loaderParam);
		AssetManagement.assetManager.finishLoading();
		
		effect = AssetManagement.assetManager.get("particles/cylinder_blue2.p", ParticleEffect.class).copy();
		effect.init();
