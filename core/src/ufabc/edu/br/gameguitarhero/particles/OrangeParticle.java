...
public class OrangeParticle extends AbstractParticle{

	public OrangeParticle(PerspectiveCamera camera) {
		super(camera);
		
		//Cria as partículas laranjas do jogo
		...
		AssetManagement.assetManager.load("particles/cylinder_orange2.p", ParticleEffect.class, loaderParam);
		AssetManagement.assetManager.finishLoading();
		
		effect = AssetManagement.assetManager.get("particles/cylinder_orange2.p", ParticleEffect.class).copy();
		effect.init();
