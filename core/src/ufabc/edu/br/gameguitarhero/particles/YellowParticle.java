...
public class YellowParticle extends AbstractParticle{

	public YellowParticle(PerspectiveCamera camera) {
		super(camera);
		
		//Cria as partículas amarelas do jogo
		...
		AssetManagement.assetManager.load("particles/cylinder_yellow2.p", ParticleEffect.class, loaderParam);
		AssetManagement.assetManager.finishLoading();
		
		effect = AssetManagement.assetManager.get("particles/cylinder_yellow2.p", ParticleEffect.class).copy();
		effect.init();
		Vector3 translation = new Vector3(-0.1f, 0.45f, 4.6f);
